...
import "./Car/car.css"
import wond from './Car/Car image/wond.jpg';
...
const unsplash=createApi({
    accessKey:"9lM7OmRNIgWA69VymzRcdIig06Z0LZAKKeyaQfDTas4",

})

export default function Wonderland() {
    const [phrase, setPhrase] = useState("Places");
...
//    }
  ...
  return( <>
<Navbar/>
<div className="CarCall"><img src={wond} alt="" /></div>
<div className="CC">
  <h2>WONDERLAND PHOTOGRAPHY</h2>
  <p>Alluring venues are many but the time is so short </p>
  </div>
